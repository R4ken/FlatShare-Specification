...
\begin{itemize}
    ...
    \item \texttt{profile} – jedna z wartości: "student", "workingPerson", "tourist", "None"
...
\begin{itemize}
    ...
    \item \texttt{GET /api/v1/bookings/\{bookingId\}/me} --- w przypadku tenanta pobranie wszystkich rezerwacji które utworzył, w przypadku landlorda pobranie wszystkich bookingów dotyczących jego ogłoszeń
\end{itemize}
...
\end{lstlisting}
W przypadku, gdy płatność dotycząca danego bookingu nie została jeszcze zainicjowana, pole \texttt{paymentId} powinno przyjąć wartość pustego stringa \texttt{""}.
